...
export default function LandingPage() {
  ...
  <div id="overview" data-section="overview">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/high-tech-office-ready-stock-trading_482257-121465.jpg",
          alt: "Security Ops",
        },
        {
          src: "http://img.b2bpic.net/free-photo/employee-examining-company-performance_482257-121856.jpg",
          alt: "Support Manager",
        },
        {
  ...
  <div id="restaurants" data-section="restaurants">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 4,
          reviewCount: "150",
          imageSrc: "http://img.b2bpic.net/free-vector/bakery-text-banner-poster-design_1308-124862.jpg",
        },
        {
          id: "res6",
          brand: "Active",
          ...
          rating: 5,
          reviewCount: "400",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=6ksood",
        },
      ]}
  ...
  <div id="security" data-section="security">
      ...
      faqs={[
        {
          id: "f1",
          title: "How to soft-delete a restaurant?",
          content: "Set the `isDeleted` flag to true in the owners collection. This keeps record integrity while disabling QR access.",
        },
        {
          id: "f2",
          title: "Can I perform a hard delete?",
          content: "Yes, but it is not recommended. Use cascading delete functions to remove linked menu items if choosing hard delete.",
        },
        {
          id: "f3",
          title: "What happens to the QR code?",
          content: "Once the status is marked as 'suspended', the QR code will automatically trigger a 403 Forbidden error.",
        },
      ]}
      ...
      blogs={[
        {
          id: "b1",
          category: "Audit",
          title: "Access Revoked: Spice Route",
          excerpt: "User requested account suspension due to subscription expiration.",
          imageSrc: "http://img.b2bpic.net/free-vector/food-25-line-filled-icon-pack-including-food-water-vegetable-waffle-food_1142-25116.jpg",
          authorName: "Admin",
          authorAvatar: "http://img.b2bpic.net/free-photo/delicious-cuisine-taste-food-concept_53876-120881.jpg",
          date: "Oct 24, 2023",
        },
        {
          id: "b2",
          category: "Subscription",
          title: "Premium Tier Activated: Grand Bistro",
          excerpt: "Auto-renewal successful for annual billing cycle.",
          imageSrc: "http://img.b2bpic.net/free-vector/bakery-fresh-delicious-text-banner-poster-design_1308-124002.jpg",
          authorName: "System",
          authorAvatar: "http://img.b2bpic.net/free-vector/bakery-fresh-delicious-text-banner-poster-design_1308-128241.jpg",
          date: "Oct 22, 2023",
        },
        {
          id: "b3",
          category: "Security",
          title: "Cascading Cleanup Successful",
          excerpt: "Menu items for deleted outlet #982 cleared from DB.",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=umxvcp",
          authorName: "System",
          authorAvatar: "http://img.b2bpic.net/free-vector/flat-design-fire-label-badge-collection_23-2147728171.jpg",
          date: "Oct 20, 2023",
        },
      ]}
    />
